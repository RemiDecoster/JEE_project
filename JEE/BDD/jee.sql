...
CREATE  TABLE IF NOT EXISTS `enssat_tp`.`ListeEtudiants` (
  ...
  INDEX `fk_Etudiants_has_table1_table11` (`idGroupe` ASC) ,
  INDEX `fk_Etudiants_has_table1_Etudiants` (`numetudiant` ASC) ,
...
START TRANSACTION;
USE `enssat_tp`;
INSERT INTO `enssat_tp`.`Etudiants` (`numetudiant`, `nom`, `prenom`, `ddn`, `emailPro`, `emailPerso`, `bac`, `anBac`, `menBac`, `diplome`, `anDiplome`, `villeDiplome`, `S`, `inscription`) VALUES ('mrj', 'muto', 'yugi', '01/04/1995', 'yugi@kaibacorp.com', 'exodia@otk.com', 's', '2010', 'TB', 'duelMaster', '2012', 'Pagasus', 'M', '2011');
